...
library(readxl)
eggDATA<-read_xls("eggfail230906-concentration.xls", sheet="Sheet1" )
str(eggDATA)
colnames(eggDATA)
...
Concentration<-read_xlsx("CondProb.xlsx",sheet = "Sheet1")
summary(Concentration$Enrofloxacin浓度)
Concentration$Enrofloxacin浓度<-as.numeric(Concentration$Enrofloxacin)
